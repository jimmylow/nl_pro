    ...
    if ($_POST['Submit'] == "Save") {
     ...
     if ($suppcd <> "") {
      ...
      if ($res_id->cnt > 0 ) {
         ...
         $sql .= "  city_2, postal_code_2, state_2, country_2, gstno) values ";
         ...
         $sql .= "   '$suppstate_2','$suppcount_2', '$gstno')";
  //       echo $sql;
//         break;
         mysql_query($sql); 
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 1065px;" class="style2">
	 <legend class="title">SUPPLIER MASTER</legend>
	  ...
	  <form name="InpSuppMas" method="POST" onsubmit="return validateForm()" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" style="height: 134px; width: 1019px;" class="auto-style1">
	   <table style="width: 1012px">
	    <tr>
	      <td></td>
	      <td class="tdlabel" style="width: 115px">Supplier Code<span class="style4">*</span></td>
	      <td>:</td>
	  	  <td>
          ...
          <td><div id="msgcd"></div></td>
	   	 ...
	   	 <tr>
	   	  <td></td>
	  	  <td class="tdlabel" style="width: 115px">Supplier Name<span class="style4">*</span></td>
	  	  <td>:</td>
	  	  <td>
		  <input class="inputtxt" name="suppname" id ="suppnmid" type="text" maxlength="50" onchange ="upperCase(this.id)" style="width: 361px">
		  </td>
		  <td></td>
         ...
         <tr>
          <td></td>
          <td style="width: 115px">Local/Oversea</td>
          <td>:</td>
          <td>
         ...
         <tr>
          <td></td>
          <td style="width: 115px">Pay Mode</td>
          <td>:</td>
          <td>
         ...
         <tr>
          <td></td>
          <td style="width: 115px">Item Supplied</td>
          <td>:</td>
          <td>
		    <input class="inputtxt" name="suppitms" id ="suppitmsid" type="text" maxlength="80" style="width: 362px"></td>
          <td></td>
          <td>GST ID No</td>
          <td></td>
          <td>
          <input class="inputtxt" name="gstno" id ="gstno" type="text" maxlength="80" style="width: 100px"></td>
          </td>
         </tr>
         <tr><td></td></tr>
         <tr>
          <td></td>
          <td style="width: 115px">Remark</td>
          <td>:</td>
          <td>
		  <input class="inputtxt" name="supprmk" id ="supprmkid" type="text" maxlength="80" style="width: 363px"></td>
          <td></td>
          <td></td>
          <td></td>
         </tr>
