         	 ...
         	 <?php
		    	...
		    	$rs_result = mysql_query($sql) or die(mysql_error()); 
         	 	...
         	 	while ($row = mysql_fetch_assoc($rs_result)){
         	 		...
         	 		$sql1 = "select currency_desc from currency_master ";
        			$sql1 .= " where currency_code ='".$row['curr_code']."'";
        			...
        			$currdesc = $row1[0];
         	  		...
         	  		echo '<td align="center">';
			       		...
			       		$sqlq = "select currency_code, currency_desc from currency_master ORDER BY currency_code";
                   		$sql_resultq = mysql_query($sqlq);
				   		
				   		if(mysql_num_rows($sql_resultq)) 
				   		{
				   	 		while($rowq = mysql_fetch_assoc($sql_resultq)) 
				     		{ 
					  			echo '<option value="'.$rowq['currency_code'].'">'.$rowq['currency_code']." | ".$rowq['currency_desc'].'</option>';
				 	 		} 
				   		} 
	            		echo '</select>';
              		echo '</td>';
