...
<body>
	<fieldset name="Group1" style=" width: 718px;" class="style2">
	 <legend class="title">TYPE MASTER</legend>
	  <br>
	  <fieldset name="Group1" style="width: 707px; height: 128px">
	  <form name="InpTypeMas" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="height: 134px; width: 696px;">
		<table>
	  	  <tr>
	  	    <td>
	  	    </td>
			...
			<input class="inputtxt" name="typecd" id ="typecdid" type="text" maxlength="10" onchange ="upperCase(this.id)" onBlur="AjaxFunction(this.value);">
			</td>
	  	  </tr>
	  	  <tr>
	  	    <td></td> 
            ...
            <td style="width: 505px"><div id="msgcd"></div></td> 
	  	    ...
	  	    <td style="width: 138px" class="tdlabel">Type Description</td>
	  	    <td>:</td>
	  	    <td style="width: 505px">
