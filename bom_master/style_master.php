		...
		new AjaxUpload(btnUpload, {
			...
			onComplete: function(file, response){
				...
				if(response==="success"){
					...
					$('<li></li>').appendTo('#files').html('<img src="styimg/'+file+'" alt="" height="120" width="130" /><br />').addClass('success');
				} else{
...
<body>
	<fieldset name="Group1" style=" width: 718px;" class="style2">
	 <legend class="title">STYLE MASTER</legend>
	  <br>
	   <form name="InpStyleMas" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="height: 347px; width: 696px;">
		<table>
	  	  <tr>
	  	    <td>
	  	    </td>
		  ...
		  <tr>
 	       ...
 	       <tr>
	  	    ...
	  	    <td style="width: 505px">
	  	     <div id="files"> 
	  	     <li class="success" style="width: 232px">
              </li>
             </div>
	  	     <br>
			 <div id="me" class="styleall" style=" cursor:pointer; width: 198px;">
			 <span style=" cursor:pointer; font-family:Verdana, Geneva, sans-serif; font-size:9px;">
	  	     Click Here To Upload Style Photo
	  	     </span>
	  	     </div>
	  	     </td>
	  	  </tr>  
 		  <tr>
	  	    ...
	  	    <td></td>
	  	    <td></td>
	  	    <td style="width: 505px"><span id="mestatus" ></span></td>
	  	  </tr>  
           <tr>
	   	    <td>
	  	    </td>
	   ...
	   <fieldset>
	    <form name="LstTypeMas" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
         ...
         <thead><tr>
          ...
          <th class="tabheader" style="width: 138px">Style </th>
          <th class="tabheader" style="width: 303px">&nbsp;Style Description</th>
