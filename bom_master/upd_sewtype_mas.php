    ...
    if($var_loginid == "") { 
     ...
     if ($_POST['Submit'] == "Update") {   
        ...
        $var_menucode  = $_POST['menudcode'];
         ...
         $sql = "Update prosewtype_master set sewtype_desc ='$vartypede',";
         $sql .= " modified_by='$var_loginid',";
         $sql .= " modified_on='$vartoday', stat = '$var_stat' WHERE sewtype_code = '$vartypecd'";
           
       	 mysql_query($sql); 
                
         $backloc = "../bom_master/product_sewtype_master.php?menucd=".$var_menucode;
         echo "<script>";
...
<?php
 	$sql = "select create_by, create_on, modified_by, modified_on, stat ";
   	...
   	$sql .= " where sewtype_code ='$var_typecd'";   
...
<body OnLoad="document.InpTypeMas.typede.focus();">
  ...
  <div class="contentc">
	<fieldset name="Group1" style="height: 439px; width: 714px;" class="style2">
	 <legend class="title">EDIT SEWING TYPE MASTER</legend>
	  <br>
	  ...
	  <form name="InpTypeMas" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="height: 134px">
		...
		<table>
	  	  <tr>
	  	    ...
	  	    <td style="width: 138px" class="tdlabel">Sewing Type</td>
	  	    <td>:</td>
	  	    <td>
	  	      <input readonly="readonly" class="textnoentry1" name="typecd" id ="typecdid" type="text" value="<?php echo $var_typecd; ?>" style="width: 128px">
			</td>
			<td></td>
			<td>Status</td>
			<td>:</td>
