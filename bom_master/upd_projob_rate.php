	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()">
		...
		<table style="width: 637px; height: 96px;">
	  	  ...
	  	  <tr>
	  	   ...
	  	   <td>:</td>
	  	   <td>
		   <input class="inputtxt" name="procddesc" readonly="readonly" id ="procddescid" type="text" style="width: 363px;" value="<?php echo $proddesc; ?>"></td>
		  ...
		  <tr>
	  	   ...
	  	   <td>:</td>
	  	   <td>
		   <input class="textnoentry1" readonly="readonly" name="totaljob" id ="totaljobid" type="text" style="width: 200px;" value="<?php echo $vartotal; ?>">
		   </td>
	  	  </tr>
			<tr>
	  	   <td style="width: 14px"></td>
