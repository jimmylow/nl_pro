...
<body>
  ...
  <?php
     ...
     $modified_by= $row['upd_by'];
 	 ...
 	 $sql2 = "select stat, remark from po_over ";
     $sql2 .= " where trx_no ='".$rm_receive_id."'";
	 ...
	 if ($stat <> 'APPROVED' or $stat <> 'REJECTED')
	 {
	 	$sqlins = " UPDATE po_over SET stat = 'VIEWED/PENDING' WHERE trx_no = '". $rm_receive_id."'";
     	//mysql_query($sqlins) or die("Error Update Approval Table : ".mysql_error(). ' Failed SQL is --> '. $sqlins);
     }
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 988px;" class="style2">
	 <legend class="title">RAW MAT RECEIVE OVER 10 % DETAILS&nbsp; :<?php echo $var_revno;?></legend>
	  <br>	 
		...
		<table style="width: 886px">
		   ...
		   <td style="width: 29px"></td>
			...
			<tr>
	  	   ...
	  	   <td style="width: 13px">:</td>
	  	   <td colspan="5">
		   <input name="remarks" id="remarks" type="text" style="width: 588px" readonly="readonly" value="<?php echo $remarks; ?>" class="textnoentry1">
		   </td>
		    </tr>
	  	    <tr>
	  	   <td></td>
			...
			<tr>
	  	   <td></td>
	  	   <td style="width: 126px">Status</td>
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 239px">
		   <input name="stat" id="ponoid0" type="text" style="width: 189px" readonly="readonly" value="<?php echo $stat; ?>" class="textnoentry1"></td>
	  	    </tr>
	  	   <tr>
	  	   <td></td>
	  	   <td style="width: 126px"><?php if($stat=='REJECTED'){ echo 'Rejected Reasons';}?></td>
	  	   <td style="width: 13px"></td>
	  	   <td style="width: 239px">
	  	   <?php if($stat=='REJECTED'){
		   echo '<input name="remark" id="ponoid1" type="text" style="width: 189px" readonly="readonly" value="'.$remark.'" class="textnoentry1">';
		   }?>
		   </td>
	  	  </tr>
		  ...
		  <table id="itemsTable" class="general-table" style="width:887px">
              ...
              <th class="tabheader" style="width: 130px">Raw Material Item</th>
              ...
              <th class="tabheader" style="width: 109px" title="QTY Shown Not Include This Receiving">Total Received</th>
            ...
            <tbody>            
             <?php
				...
				while ($rowq = mysql_fetch_assoc($rs_result)){
					...
					echo '<td><input name="promat[]" value="'.$rowq['item_code'].'" id="procomatid" style="width: 150px; border-style: none;" readonly="readonly"></td>';
                	...
                	echo '<td><input name="uprice[]" tMark="1" id="uprice" readonly="readonly" style="width: 75px; border:0;" value="'.$receivedqty.'" title="Qty Shown Not including current receiving QTY"></td>';
		 ...
		 <table>
		  	<tr>
				...
				<?php
				 $locatr = "poover_appr.php?menucd=".$var_menucode;
