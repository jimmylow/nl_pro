$(document).ready(function(){
    ...
    var rowTemp = [
         '<tr class="item-row">',
            ...
            '<td><input name="procomark[]" id="'+idprocomark+'" readonly="readonly" style="width: 75px; border:0; text-align:right;"></td>',
            '<td><input name="issueqty[]" id="'+idissueqty+'" onBlur="calcCost('+rowCount+');" style="width: 75px; text-align:right;"></td>',
        '</tr>'
    ].join('');
