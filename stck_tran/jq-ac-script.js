$(document).ready(function(){
    ...
    // Format the list menu output of the autocomplete
        ...
        return $( "<li></li>" )
            ...
            .append( "<a>" + item.rm_code + " - " + item.colour + " - " + item.mark + " - " + item.remark + "</a>" )
            .appendTo( ul );
    };
    ...
    var rowTemp = [
         '<tr class="item-row">',
            ...
            '<td><input name="issueqty[]" id="'+idissueqty+'" onBlur="calcCost('+rowCount+');" style="width: 75px"></td>',
            '<td><input name="price[]" id="'+idprice+'" onBlur="calcCost('+rowCount+');" style="width: 75px"></td>',
        ...
        if ( $('#procomat1:last').val() !== '' ) {
            ...
            $row.find('#procomat'+rowCount).autocomplete({
                ...
                return $( "<li></li>" )
                    .data( "item.autocomplete", item )
                    .append( "<a>" + item.rm_code + " - " + item.uom + " - " + item.size + " - " + item.remark + "</a>" )
                    .appendTo( ul );
            };
