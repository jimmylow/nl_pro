...
<body>
  ...
  $sql = "SELECT * FROM rawmat_receive X, rawmat_receive_tran Y ";
  $sql.= " WHERE myr_unit_cost = 0 ";
  $sql.= " AND x.rm_receive_id = y.rm_receive_id ";
  //$sql.= " AND x.rm_receive_id = 'REC001169' ";
   ...
   {
     	$po_no= $row['po_number'];        
     	$matcode = $row['item_code']; 
     	$uprice = $row['unit_cost']; 
     	$rm_receive_id= $row['rm_receive_id']; 
     	$prorevdte = $row['grndate']; 
		...
		$sql.= " AND item_code = '$matcode'";
		$sql.= " AND myr_unit_cost = '0'";
