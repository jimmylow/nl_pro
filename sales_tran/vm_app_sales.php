   ...
   if (isset($_POST['Submit'])){ 
     ...
     if ($_POST['Submit'] == "Print") {
       ...
       // Redirect browser
        ...
        $dest = "http://".$var_prtserver.":8080/birt-viewer/frameset?__report=clr_rpt.rptdesign&__title=";
...
<body>
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 960px;" class="style2">
	 <legend class="title">BUYER PURCHASE ORDER - <?php echo $var_sor; ?></legend>
	  <br>	 
	  ...
	  <form name="InpSalesF" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>">
	   ...
	   <input name="buycd" type="hidden" value="<?php echo $var_buy;?>">
		...
		<table style="width: 1014px">
		  ...
		  <tr>
	  	   <td style="width: 13px"></td>
	  	   <td style="width: 122px">Buyer Name</td>
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 201px">
	  	   	<input class="inputtxt" name="sabuycd" readonly="readonly" id ="sabuycd" type="text" style="width: 61px;" value="<?php  echo $var_buy; ?>">
		   	<label><?php echo $buycdde;?></label>
		   </td>
		   <td style="width: 10px"></td>
            ...
            <tbody>
             <?php
			    ...
			    while ($rowq = mysql_fetch_assoc($rs_result)){
                    ...
                    echo '<td><input name="procd[]" value="'.$rowq['sprocd'].'" tProCd1=1 id="procd1" style="width: 175px""></td>';
                    echo '<td><input name="procdbuyer[]" value="'.$rowq['sprocdbuyer'].'" tProCd1=1 id="procdbuyer1" style="width: 175px""></td>';
                    ...
                    echo '<td><input name="proorqty[]" style="width: 97px; text-align:center;" value="'.$rowq['sproqty'].'"></td>';
                    echo '<td><input name="prouom[]" value="'.$rowq['sprouom'].'" style="width: 75px; border-style: none; border-color: inherit; border-width: 0;"></td>';
                    echo '<td><input name="prooupri[]" id="prooupri1" value="'.$rowq['sprounipri'].'" style="width: 89px; text-align:right;"></td>';
		 ...
		 <table>
		  	<tr>
				...
				<?php
				 $locatr = "sales_appr.php?menucd=".$var_menucode;
