$(document).ready(function(){
    ...
    var rowTemp = [
          ...
          '<td><input name="procd[]" value="" tProCd'+rowCount+'="1" id="'+idprocd+'" class="autosearch" style="width: 110px" onchange ="upperCase(this.id)" onblur="get_desc(this.value, '+rowCount+')"></td>',
          '<td><input name="procdbuyer[]" value="" tProCd'+rowCount+'="1" id="'+idprocdbuy+'" style="width: 110px"></td>',
