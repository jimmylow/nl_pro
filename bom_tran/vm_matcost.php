...
{
	var newwindow;
	newwindow=window.open(url,'name','height=800,width=800,left=30,top=200');
...
<body>
  ...
  <div class ="contentc">
	...
	<fieldset name="Group1" style=" width: 891px;" class="style2">
	  ...
	  <br>	 
	  	  <table>
	  	  	<tr>
	  	  		...
	  	  		<td>Costing No</td>
	  	  		<td>:</td>
	  	  		<td><input type="text" name="costinno" id="costinno" value="<?php echo $var_costinno; ?>"></td>
	  	  	</tr>
	  	  	<tr>
	  	  		<td></td>
	  	  	</tr>
	   ...
	   <table>
	  	<tr>
			<td style="width: 891px; height: 22px;" align="center">
			<?php
				 $locatr = "m_mat_plan.php?menucd=".$var_menucode;
				 $prnpath = "matplanrpt.php?opt=".$var_costinno;
				 echo '<input type="button" value="Back" class="butsub" style="width: 60px; height: 32px" onclick="location.href=\''.$locatr.'\'" >';
			?>
				<input type="button" value="Print" class="butsub" style="width: 60px; height: 32px" onclick="newWindow('<?php echo $prnpath; ?>')" />
				</td>
			</tr>
	  </table>
