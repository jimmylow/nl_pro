     ...
     if ($_POST['Submit'] == "Update") {
        ...
        $var_menucode  = $_POST['menudcode'];
         ...
         if ($vardecd <> "") {
         	...
         	$vartoday = date("Y-m-d");
         	$sql = "Update wor_deptmas set deptdesc ='$vardede',";
         	$sql .= " modified_by='$var_loginid',";
         	$sql .= " modified_on='$vartoday' WHERE deptcode = '$vardecd'";      
...
<div class="contentc">
	...
	<fieldset name="Group1" style="height: 270px; width: 718px;" class="style2">
	 <legend class="title">EDIT DEPARTMENT CODE MASTER</legend>
	 <br>
	  <form name="InpDeptMas" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="height: 134px" onSubmit= "return chkSubmit()">
		...
		<table>
	  	  <tr>
	  	    ...
	  	    <td style="width: 147px" class="tdlabel">Department&nbsp; Code</td>
	  	    <td>:</td>
	  	    <td>
           ...
           <td style="width: 264px">
	  	  ...
	  	  <tr>
	  	   ...
	  	   <td>
	  	   <?php
				 $locatr = "dept_mas.php?menucd=".$var_menucode;
