    ...
    if (isset($_POST['Submit'])){ 
     if ($_POST['Submit'] == "Print") {
		...
		while ($row = mysql_fetch_assoc($rs_result)) { 
		 ...
		 switch($gpopt){
		 case 1:	
     	 		$fname = "detqctic_gpptyp.rptdesign&__title=myReport";
     	 		break;
     	 case 2:
     	 		$fname = "detqctic_grpbu.rptdesign&__title=myReport";
     	 		break;
     	 case 3:
     	 		$fname = "detqctic_grppr.rptdesign&__title=myReport";
     	 		break;
     	 }						 
         ...
         $backloc = "../prod_rpt/detqctic_rpt.php?menucd=".$var_menucode;
       	 echo "<script>";
...
<body onload="setup()">
   <?php include("../topbarm.php"); ?> 
	...
	<fieldset name="Group1" style=" width: 758px; height: 205px;" class="style2">
	 <legend class="title">QC PRODUCT IN DETAIL (BY TICKET DATE)</legend>
	  <br />
