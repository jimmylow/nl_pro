    ...
    if (isset($_POST['Submit'])){ 
     if ($_POST['Submit'] == "Print") {
		$fdte = date("Y-m-d", strtotime($_POST['rptofdte']));
     	...
     	$fname = "cutinrpt.rptdesign&__title=myReport"; 
        ...
        $dest .= "&fp=".$fprd."&tp=".$tprd."&fb=".$fbuy."&tb=".$tbuy;
        $dest .= urlencode(realpath($fname));

         //header("Location: $dest" );
         echo "<script language=\"javascript\">window.open('".$dest."','name','height=1000,width=1000,left=200,top=200');</script>";
       //  $backloc = "../prod_rpt/cutin_rpt.php?menucd=".$var_menucode;
       //	 echo "<script>";
...
<body onload="setup()">
   <?php include("../topbarm.php"); ?> 
	...
	<fieldset name="Group1" style=" width: 650px; height: 280px;" class="style2">
	 <legend class="title">CUTTING IN REPORT</legend>
	  <br />
		    ...
		    <tr>
		    	...
		    	<td style="width: 242px">
		    		<select name="selfprd" id ="selfprd" style="width: 150px">
			   		<?php
                   		$sql = "select prod_code, prod_desc from pro_cd_master where actvty != 'D' ORDER BY prod_code";
