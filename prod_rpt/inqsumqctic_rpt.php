     ...
     if ($_POST['Submit'] == "Print") {
		...
		while ($row = mysql_fetch_assoc($rs_result)) { 
			...
			$area        = $row['areacd'];
		   	...
		   	if (empty($ticketdate)){$ticketdate = '0000-00-00';}
		 ...
		 switch($gpopt){
		 case 1:	
     	 		$fname = "sumqctic_gpptyp.rptdesign&__title=myReport";
     	 		break;
     	 case 2:
     	 		$fname = "sumqctic_grpbu.rptdesign&__title=myReport";
     	 		break;
     	 }						 
         ...
         $backloc = "../prod_rpt/inqsumqctic_rpt.php?menucd=".$var_menucode;
       	 echo "<script>";
...
<body onload="setup()">
   <?php include("../topbarm.php"); ?> 
	...
	<fieldset name="Group1" style=" width: 758px; height: 205px;" class="style2">
	 <legend class="title">QC PRODUCT SUMMARY (BY TICKET DATE)</legend>
	  <br />
