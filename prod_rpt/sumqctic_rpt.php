    ...
    if (isset($_POST['Submit'])){ 
     if ($_POST['Submit'] == "Print") {
		$fdte = date("Y-m-d", strtotime($_POST['rptofdte']));
     	...
     	$sql  = " Delete From tmpqcrpt where usernm = '$var_loginid'";
        mysql_query($sql) or die("Unable To Prepare Temp Table For Printing".mysql_error());

		$sql  = "SELECT x.ticketno, x.sewtype, x.productcode, y.okqty, y.defectqty";
		...
		while ($row = mysql_fetch_assoc($rs_result)) { 
		   	...
		   	$sqlc  = "select pro_cat, cost_pcsprice";
         ...
         $backloc = "../prod_rpt/sumqctic_rpt.php?menucd=".$var_menucode;
       	 echo "<script>";
...
<body onload="setup()">
   <?php include("../topbarm.php"); ?> 
	<div class="contentc">
	<fieldset name="Group1" style=" width: 780px; height: 205px;" class="style2">
	 <legend class="title">SUMMARY QC TICKET REPORT</legend>
	  <br />
