...
<?php 
	...
	//$sql .= " WHERE prod_code in ('M457-FR-MIX', 'M457-XL-MIX', 'M458-FR-MIX')";
	...
	while ($rowq = mysql_fetch_assoc($rs_result)) {
	    ...
	    $sql = "INSERT INTO tmpwipstk ";
	    $sql.= " VALUES ('".$rowq['prod_code']."', '$proddesc', '$onhandbal', '$unitprice', '$amt', '$var_loginid')";
	    
	    mysql_query($sql) or die("Failed to insert Temp Table tmpwipstk : ".mysql_error());
