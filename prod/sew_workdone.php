<?php
    ...
    if ($_POST['Submit'] == "Save") 
    {
		...
		if ($cnt > 0 )
		{       
			$backloc = "../prod/sew_workdone.php?stat=3&menucd=".$var_menucode;
			echo "<script>";
 ...
 <?php include("../topbarm.php"); ?> 
  ...
  <div class ="contentc">
	...
	<fieldset name="Group1" style="width: 1150px;" class="style2">
	 <legend class="title">SEWING WORK DONE ENTRY</legend>
	  <br>	 
	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()">
		...
		<table style="width: 886px">
	   	  <tr>
	  	   <td></td>
	  	   <td style="width: 126px">Barcode</td>
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 272px">
		   <input class="autosearch" name="prod_code" id="prod_code" type="text" maxlength="15" style="width: 129px" onblur="getState(this.value)" tabindex="1" ></td>
		   <td></td>
	  	   <td style="width: 126px">Product No</td>
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 239px">
		   <input name="productno" id ="productnoid" type="text" style="width: 128px; text-align:center;" readonly="readonly" class="textnoentry1" ></td>
	  	  </tr>
	  	   <tr>
	  	   <td></td>
	  	   <td colspan="3"><div id="msgcd"></div></td>
	  	  </tr>
		  <tr>
		   ...
		   <input name="ticketno" id ="ticketnoid" type="text" style="width: 128px; text-align:center;" readonly="readonly" class="textnoentry1" ></td>
		   <td style="height: 27px"></td>
		   <td style="height: 27px">Job Code</td>
		   <td style="height: 27px">:</td>
		    <td style="height: 27px">
		   <input name="jobcode" id ="jobcodeid" type="text" style="width: 128px; text-align:center;" readonly="readonly" class="textnoentry1" ></td>
		  </tr> 
		  <tr>
	  	   <td></td>
		   ...
		   <td>:</td>
		   <td>
		   <input name="jobrate" id ="jobrateid" type="text" style="width: 128px; text-align:center;" readonly="readonly" class="textnoentry1" ></td>
	  	  </tr>
		  <tr>
	  	   <td></td>
	  	   <td style="width: 126px">&nbsp;</td>
		   ...
		   <td>:</td>
		    <td>
		   <input name="productqty" id ="productqtyid" type="text" style="width: 128px; text-align:center;" readonly="readonly" class="textnoentry1" ></td>
	  	  </tr>
	  	   <tr>
	  	   <td></td>
        ...
        echo '>'.$row['workid']." | ".$row['workname'].'</option>';
		   ...
		   <td>:</td>
		    <td>
		    <input class="inputtxt" name="qtydoz" id ="qtydozid" type="text" style="width: 128px;" tabindex="3" value="0" ></td>
	  	  </tr>
	  	    <tr>
	  	   <td></td>
		   ...
		   <td>:</td>
		    <td>
		   <input class="inputtxt" name="qtypcs" id ="qtypcsid" type="text" style="width: 128px;" tabindex="5" value="0" >
		   </td>
	  	    </tr>
			<tr>
	  	   <td></td>
