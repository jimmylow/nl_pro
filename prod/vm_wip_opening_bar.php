...
<body>
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 950px;" class="style2">
	 <legend class="title">WIP OPENING DETAILS&nbsp; :<?php echo $var_revno;?></legend>
	  <br>	 
	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>">
		...
		<table style="width: 886px">
			...
			<input name="openingno" id="openingnoid" type="text" maxlength="10" style="width: 191px;" readonly="readonly" value="<?php echo $wip_opening_id; ?>">
	  	  </tr>  
	  	  <tr>
	  	   <td></td>
            ...
            <tbody>            
             <?php
				...
				while ($rowq = mysql_fetch_assoc($rs_result)){
                	...
                	echo '<td><input name="procomark[]" id="procomark" readonly="readonly" style="width: 75px; border:0;" value="'.$rowq['ticketno'].'"></td>';
