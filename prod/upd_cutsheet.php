    ...
    if ($_POST['Submit'] == "Update") {
        ...
        mysql_query($sqlchk) or die(mysql_error());
		 ...
		 {	
     	 ...
     	 $backloc = "upd_csrmcode.php?menucd=".$var_menucode."&c=".$cutno;
         echo "<script>";
	  ...
	  <form name="InpCutSheet" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()" style="height: 497px; width: 929px;">
		<table style="width: 938px; height: 432px;">
		 <tr>
	  	    ...
	  	    <td style="width: 82px;">
				<input class="inputtxt" name="cutsheno" id="cutsheno" type="text" style="width: 196px;" value="<?php echo $cutno; ?>" readonly="readonly"></td>
		  ...
		  <tr>
	  	  ...
	  	  <tr>
	  	  	...
	  	  	<td style="height: 26px">
		   		<input class="inputtxt" name="salorddte" id ="salorddte" type="text" style="width: 128px;" value="<?php echo  $orddte; ?>" readonly="readonly"></td>
	  	  </tr>
	  	  <tr><td></td></tr>
		  <tr>
		  	  <td></td>
		  	  ...
		  	  <td>:</td>
		  	  <td>
		   		<input class="inputtxt" name="saldelidte" id ="saldelidte" type="text" style="width: 128px;" value="<?php echo $deldte; ?>"></td>
		   	  <td></td>
		   	  <td>Group</td>
		   	  <td>:</td>
		   	  <td>
			    ...
			    <?php
                   ...
                   $sql_result = mysql_query($sql);
                   echo "<option size=30 selected value=".$grpno.">".$grpno." - ".$sgrpde."</option>";
                   echo "<option></option>";    
		  ...
		  <tr>
		  	...
		  	<td>:</td>
		  	<td>
			<input class="inputtxt" name="prodno" id ="prodno" type="text" style="width: 95px;" value="<?php echo $prodno; ?>" readonly="readonly"></td>
		  	<td></td>
		  	<td>Color</td>
		  	<td>:</td>
		  	<td>
			<input class="inputtxt" name="colno" id ="colno" type="text" style="width: 95px;" value="<?php echo $colno; ?>" readonly="readonly">
			...
			<?php 
				...
				while ($rowq = mysql_fetch_assoc($rs_result)){
			        ...
			        echo '<td><input name="prsize[]" value="'.$prsize.'" id="prsize'.$i.'" style="width: 100px; border-style: none;"  readonly="readonly"></td>';
          	  		echo '<td><input name="ordqty[]" value="'.$ordqty.'" id="ordqty'.$i.'" style="width: 100px; text-align: right"></td>';
