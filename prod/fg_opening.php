<?php
    ...
    if ($_POST['Submit'] == "Save") {
		...
		if ($refno <> "") {
     		...
     		{
     			$sysno = '0';
     					$sysno_sql = "INSERT INTO system_number values ('OPENING_FG', '$sysno')";
         	...
         	$vartoday = date("Y-m-d H:i:s");
				$sql = "INSERT INTO fg_opening values 
				...
				$updsysno_sql = "UPDATE system_number SET sysno = '$newsysno' WHERE type = 'OPENING_FG'";
...
<body onload="setup()">
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 930px;" class="style2">
	 <legend class="title">FINISH GOODS OPENING</legend>
	  <br>	 
