<?php
    ...
    if ($_POST['Submit'] == "Save") {
		...
		if ($refno <> "") {
     		...
     		{
     			$sysno = '0';
     					$sysno_sql = "INSERT INTO system_number values ('ADJUST_FG', '$sysno')";
         	...
         	$vartoday = date("Y-m-d H:i:s");
				$sql = "INSERT INTO fg_adjust values 
				...
				$updsysno_sql = "UPDATE system_number SET sysno = '$newsysno' WHERE type = 'ADJUST_FG'";
...
function validateForm()
{
    ...
    for (var j = 1; j < rowCount; j++){
       ...
       if (rowItem != ""){
       	var strURL="aja_chk_subCodeCount.php?fgcdg="+rowItem;
	   	var req = getXMLHTTP();
        if (req)
	  	{
...
<body onload="setup()">
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 930px;" class="style2">
	 <legend class="title">FG STOCK ADJUSTMENT</legend>
	  <br>	 
