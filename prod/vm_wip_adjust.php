...
<body>
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 950px;" class="style2">
	 <legend class="title">WIP ADJUSTMENT DETAILS&nbsp; :<?php echo $var_revno;?></legend>
	  <br>	 
	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>">
		...
		<table style="width: 886px">
			...
			<input name="adjustno" id="adjustnoid" type="text" maxlength="10" style="width: 191px;" readonly="readonly" value="<?php echo $wip_adjust_id; ?>">
	  	  </tr>  
	  	  <tr>
	  	   <td></td>
