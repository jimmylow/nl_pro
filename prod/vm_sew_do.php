...
<!--<?php include("../sidebarm.php"); ?> -->
  ...
  <div class="contentc" style="width: 926px;">
	...
	<fieldset name="Group1" style=" width: 901px;">
	 <legend class="title">SEWING DELIVERY ORDER - <?php $sew_doid= $_GET['donum']; echo $sew_doid; ?></legend>
	 <table>
	     <tr>
	  	   <td style="width: 126px;">Delivery Order</td>
	  	   <td style="width: 13px;">:</td>
	  	   <td style="width: 182px;">
		   <input name="sew_doid" id ="totproductid3" type="text" style="width: 156px; text-align:center;" tabindex="3" onblur="showoveDecimal(this.value)" value="<?php echo $sew_doid;?>" class="textnoentry1"></td>
	  	   <td style="width: 13px;"></td>
