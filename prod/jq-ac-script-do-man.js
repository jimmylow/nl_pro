$(document).ready(function(){
    ...
    var rowTemp = [
         '<tr class="item-row">',
            ...
            '<td><input name="procouom[]" value="" class="tInput" id="procouom" onBlur="getUprice('+rowCount+');" style="width: 65px; text-align: right;"></td>',
            '<td><input name="procoprice[]" value="" class="tInput" id="'+idprocoprice+'" onBlur="getUprice('+rowCount+');" style="width: 92px; text-align : right"></td>',
