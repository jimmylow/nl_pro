<?php
    ...
    if ($_POST['Submit'] == "OK") 
    {
    	...
    	if ($workerid==NULL or $workerid=='' or $workerid == ' '){
			$backloc = "../prod/sew_workdone_old3.php?stat=7&menucd=".$var_menucode;
			echo "<script>";
			echo 'location.replace("'.$backloc.'")';
			echo "</script>"; 

    	}else{
	    	$backloc = "../prod/sew_workdone_old3.php?menucd=".$var_menucode."&workerid=".$workerid."&sewdate=".$sewdate;
    ...
    if ($_POST['Submit'] == "Save") 
    {
		...
		{       
			...
			$sql.= " SET workid ='$workerid', sewdate = '$prorevdte', qtydoz = '$qtydoz', qtypcs = '$qtypcs', prog_name = 'sew_workdone_old'";
 ...
 <?php include("../topbarm.php"); ?> 
  ...
  <div class ="contentc">
	...
	<fieldset name="Group1" style="width: 1150px;" class="style2">
	 <legend class="title">SEWING WORK DONE ENTRY (OLD SYSTEM BARCODE)- SELECT WORKER &amp; DATE</legend>
	  <br>	 
	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()">
		...
		<table style="width: 886px">
	  	   ...
	  	   <td style="width: 272px; height: 26px;">
		   	<select name="grpcd" id="grpcd" style="width: 268px" tabindex="1" >
			 <?php
