<?php
    ...
    if ($_POST['Submit'] == "Save") {
		...
		if ($refno <> "") {
     		...
     		$sqlchk.= " where type = 'OPENING_WIP_BAR'";
     		...
     		{
     			$sysno = '0';
     					$sysno_sql = "INSERT INTO system_number values ('OPENING_WIP_BAR', '$sysno')";
         	...
         	$vartoday = date("Y-m-d H:i:s");
					...
					foreach($_POST['procomat'] as $row=>$matcd ) {
						...
						if ($matcode <> "")
						{
							...
							$sql = "INSERT INTO wip_opening_tran values 
						    		('$opening_sysno', '$seqno', '$matcode', '$matdesc', '$matuom','$openingqty','0', '$openingcost', '0','$ticketno')";
							mysql_query($sql) or die("query 2 :".mysql_error());
							
							$sql = "INSERT INTO wip_tran values 
						    		('OPB', '$ticketno', '$opening_sysno','$remark', '$prorevdte', '$matcode', '$openingcost', '$matdesc', '$qtyperpack', '$openingqty','$var_loginid', '$vartoday','$var_loginid', '$vartoday')";
							...
							$sql = "INSERT INTO sew_entry (ticketno, buyerorder, buyer, batchno, productcode, productqty, ";
							$sql.= " create_by, creation_time, modified_by, modified_on, stat )values ";
						    $sql.= "		('$ticketno', '$opening_sysno', '$buyer','WIPSTKCHK','$matcode', '$openingqty', '$var_loginid', '$vartoday','$var_loginid', '$vartoday', 'ACTIVE')";
				...
				$updsysno_sql = "UPDATE system_number SET sysno = '$newsysno' WHERE type = 'OPENING_WIP_BAR'";
...
<body onload="setup()">
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 930px;" class="style2">
	 <legend class="title">TICKET&nbsp; OPENING</legend>
	  <br>	 
		  ...
		  <table id="itemsTable" class="general-table" style = "width: 900px;">
            ...
            <tbody>
             ...
             <tr class="item-row">
                ...
                <td>
                <input name="procomark[]" id="procomark1" onBlur="calcCost('1');" style="width: 75px; " onchange ="upperCase(this.id)"> </td>
				<td>
				<input name="openingqty[]" id="openingqtyid1" onBlur="calcCost('1');" style="width: 75px" value="0"></td>  
				<td>
