$(document).ready(function(){
    ...
    $('#procomat1').autocomplete({
        ...
        select: function(event, ui) {
            var $itemrow = $(this).closest('tr');
                    ...
                    $itemrow.find('#adjustcostid1').val(ui.item.adjustcost);
    ...
    // Format the list menu output of the autocomplete
        ...
        return $( "<li></li>" )
            ...
            .append( "<a>" + item.prod_code + " - " + item.uom + " - " + item.remark + " - " + item.adjustcost + "</a>" )
            .appendTo( ul );
    };
    ...
    var idissueqty  = "adjustqtyid"+rowCount;
    var idadjustcost  = "adjustcostid"+rowCount
    ...
    var rowTemp = [
         '<tr class="item-row">',
            ...
            '<td><input name="adjustqty[]" id="'+idissueqty+'" onBlur="calcCost('+rowCount+');" style="width: 75px"></td>',
        ...
        var $issueqty	        = $row.find('#adjustqtyid'+rowCount);
        var $adjustcostid	        = $row.find('#adjustcostid'+rowCount);
            ...
            $row.find('#procomat'+rowCount).autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    $procodesc.val(ui.item.remark);
                  	...
                  	$adjustcostid.val(ui.item.adjustcost);
