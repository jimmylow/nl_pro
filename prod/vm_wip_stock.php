<?php
    ...
    if ($_POST['Submit'] == "Back") {
         $backloc = "../prod/m_wip.php?menucd=".$var_menucode;
         echo "<script>";
...
<body>
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 1143px;" class="style2">
	 <legend class="title">Work In Progress - <?php  $rcd = $_GET['procd']; echo $rcd ?></legend>
	 ...
	 <table cellpadding="0" cellspacing="0" id="example" class="display" width="100%">
		 ...
		 <?php 
		    ...
		    $sql .= " FROM wip_tran where item_code = '".mysql_real_escape_string($rcd)."'";
