<?php
    ...
    if ($_POST['Submit'] == "OK") 
    {
    	...
    	if ($workerid==NULL or $workerid=='' or $workerid == ' '){
			$backloc = "../prod/sew_workdone2.php?stat=7&menucd=".$var_menucode;
			echo "<script>";
			echo 'location.replace("'.$backloc.'")';
			echo "</script>"; 

    	}else{
	    	$backloc = "../prod/sew_workdone3.php?menucd=".$var_menucode."&workerid=".$workerid."&sewdate=".$sewdate;
 ...
 <?php include("../topbarm.php"); ?> 
  ...
  <div class ="contentc">
	...
	<fieldset name="Group1" style="width: 1150px;" class="style2">
	 <legend class="title">SEWING WORK DONE ENTRY - SELECT WORKER &amp; DATE</legend>
	  <br>	 
