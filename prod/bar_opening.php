...
<script  type="text/javascript" src="../prod/jq-ac-script-bar.js"></script>
	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()">
		...
		<table style="width: 886px">
		  ...
		  <table id="itemsTable" class="general-table" style = "width: 900px;">
              ...
              <th class="tabheader">Sew Type</th>
            ...
            <tbody>
             ...
             <tr class="item-row">
                ...
                <td>
				<input name="procobar[]" id="procobar" style="width: 80px" onchange ="upperCase(this.id)" ></td>
                <td>
