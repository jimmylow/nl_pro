    ...
    if($var_loginid == "") { 
	 ...
	 if ($_POST['Submit'] == "Delete") {
     	if(!empty($_POST['procd']) && is_array($_POST['procd'])) 
     	{
		   ...
		   $backloc = "../prod/m_wip_opening.php?stat=1&menucd=".$var_menucode;
           echo "<script>";
	  ...
	  <br>
        ...
        <form name="LstCatMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode;; ?>">
		 ...
		 <tr>
           ...
           <?php
                $locatr = "wip_opening.php?menucd=".$var_menucode;
                if ($var_accadd == 0){
		 ...
		 <tbody>
		 <?php 
		    $sql = "SELECT distinct wip_opening_id, refno, openingdate, upd_by, upd_on ";
		    $sql .= " FROM wip_opening ";
			...
			while ($rowq = mysql_fetch_assoc($rs_result)) { 
				...
				$urlpop = 'upd_wip_opening.php';
				$urlvie = 'vm_wip_opening.php';
