 ...
 <?php include("../topbarm.php"); ?> 
  ...
  <div class ="contentc">
	...
	<fieldset name="Group1" style="width: 1150px;" class="style2">
	 <legend class="title">SEWING TICKET QC ENTRY</legend>
	  <br>	 
	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()">
		...
		<table style="width: 886px">
	  	   ...
	  	   <td style="width: 126px; height: 32px;">Ticket No.</td>
	  	   <td style="width: 13px; height: 32px;">:</td>
	  	   <td style="width: 239px; height: 32px;">
		   <input class="autosearch" name="prod_code" id="prod_code" type="text" maxlength="15" style="width: 129px" onblur="getState(this.value)" tabindex="1" >
		   </td>
		   <td style="height: 32px"></td>
	  	   <td style="width: 126px; height: 32px;">QC Date</td>
	  	   <td style="width: 13px; height: 32px;">:</td>
	  	   <td style="width: 239px; height: 32px;"><div id="msgcd0">
		  ...
		  <tr>
		   ...
		   <td>:</td>
		    <td>
		   <input class="inputtxt" name="okqty" id ="okqtyid" type="text" style="width: 128px;" tabindex="4" onblur="showNumberOK(this.value)">
		   </td>
	  	  </tr>
	  	   <tr>
	  	   <td></td>
		   ...
		   <td>:</td>
		    <td>
		   <input class="inputtxt" name="defectqty" id ="defectqtyid" type="text" style="width: 128px;" tabindex="4" onblur="showNumberDefect(this.value)" value="0">
		   </td>
	  	  </tr>
	  	    <tr>
	  	   <td></td>
        ...
        echo '>'.$row['prod_code'].'</option>';
		   ...
		   <td>:</td>
		   <td>
		   <input class="inputtxt" name="missingqty" id ="missingqtyid" type="text" style="width: 128px;" tabindex="4" value="0" onblur="showNumberMissing(this.value)" readonly="readonly" ></td>
	  	    </tr>
			<tr>
	  	   <td></td>
		   <td>&nbsp;</td>
				...
				<?php
					if (isset($var_stat)){
						...
						case 4:
							...
							break;
						case 5:
							echo("<span>This Ticket No.Has A Record</span>");
							break;
						case 6:
