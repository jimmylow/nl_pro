...
function setup() {
		...
		document.InpRawmatReceive.ticketno.focus();
...
function getTicket(todate)
{
   ...
   var ticketno= document.InpRawmatReceive.ticketno.value;
   var jobno= document.InpRawmatReceive.jobno.value;
   

   
   var strURL="aja_get_workdone.php?ticketno="+ticketno+"&jobno="+jobno;
...
<!--<?php include("../sidebarm.php"); ?> -->
  ...
  <div class="contentc" style="width: 978px; height: 559px;">
	...
	<fieldset name="Group1" style=" width: 955px; height: 1546px;" class="style2">
	 <legend class="title" style="height: 16px">SEWING WORKDONE QUERY</legend>
	  ...
	  <form name="InpRawmatReceive" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()" style="height: 497px; width: 929px;">
		<table style="width: 1100px; height: 432px;">
		  <tr><td style="width: 5px"></td></tr>	
	  	  <tr>
	  	    <td style="width: 5px"></td>
		    <td style="width: 87px;" class="tdlabel">Ticket No.</td>
	  	    <td style="width: 5px;">:</td>
	  	    <td style="width: 212px;">
		   <input name="ticketno" id ="ticketno" onchange ="upperCase(this.id)" type="text" style="width: 200px; text-align:left;" tabindex="1"></td>
		    ...
		    <td style="width: 50px;" class="tdlabel">&nbsp;</td>
	  	    ...
	  	    <tr>
	  	    <td style="width: 5px"></td>
		    <td style="width: 87px;" class="tdlabel">Job No.</td>
	  	    <td style="width: 5px;">:</td>
	  	    <td style="width: 212px;">
		   <input name="jobno" id ="jobno" onchange ="upperCase(this.id)" type="text" style="width: 200px; text-align:left;" tabindex="2" onblur="getTicket(this.value)"></td>
			<td style="width: 9px"></td>
		    <td style="width: 50px;" class="tdlabel">&nbsp;</td>
	  	    <td style="width: 5px;">&nbsp;</td>
	  	    <td style="width: 69px;">
