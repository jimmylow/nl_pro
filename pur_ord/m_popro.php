<?php
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		//here
				if ($var_accupd == 0){	
			$row[] = '<input type="checkbox" DISABLED name="procd[]" value="'.$pon.'" title="You Are Not Authorice To Complete PO Status"/>';
		}else{
  			$row[] = '<input type="checkbox" name="procd[]" value="'.$pon.'"  title="To Complete PO status"/>';
